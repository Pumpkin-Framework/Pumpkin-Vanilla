...
/**
 * This is used to provide some context to {@link nl.jk_5.pumpkin.server.lua.Callback}s, i.e. the
...
public interface Context {
     ...
     * <ul>
     * <li><tt>null</tt> (appears as <tt>nil</tt> on the Lua side, for example)</li>
