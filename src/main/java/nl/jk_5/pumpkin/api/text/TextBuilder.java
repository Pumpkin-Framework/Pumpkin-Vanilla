...
public abstract class TextBuilder {
    ...
    public static class Translatable extends TextBuilder {
         ...
         * the given {@link nl.jk_5.pumpkin.api.text.translation.Translatable}
         * .
         *
         * @param translatable The translatable for the builder
         * @param args The arguments for the translation
         */
        public Translatable(nl.jk_5.pumpkin.api.text.translation.Translatable translatable, Object... args) {
         ...
         * {@link nl.jk_5.pumpkin.api.text.translation.Translatable}.
         *
         * @param text The text to apply the properties from
         * @param translatable The translatable for the builder
         * @param args The arguments for the translation
         */
        public Translatable(Text text, nl.jk_5.pumpkin.api.text.translation.Translatable translatable, Object... args) {
            super(text);
            translation(translatable, args);
        }
         ...
         * @return This text builder
         */
        public Translatable translation(nl.jk_5.pumpkin.api.text.translation.Translatable translatable, Object... args) {
    ...
    public static class Selector extends TextBuilder {
        ...
        protected nl.jk_5.pumpkin.api.text.selector.Selector selector;
         ...
         */
        public Selector(nl.jk_5.pumpkin.api.text.selector.Selector selector) {
            selector(selector);
        }
         ...
         * @param selector The selector for the builder
         */
        public Selector(Text text, nl.jk_5.pumpkin.api.text.selector.Selector selector) {
            super(text);
            selector(selector);
        }
         ...
         */
        public final nl.jk_5.pumpkin.api.text.selector.Selector getSelector() {
         ...
         * @see Text.Selector#getSelector()
         */
        public Selector selector(nl.jk_5.pumpkin.api.text.selector.Selector selector) {
    ...
    public static class Score extends TextBuilder {
        ...
        protected nl.jk_5.pumpkin.api.scoreboard.Score score;
         ...
         */
        public Score(nl.jk_5.pumpkin.api.scoreboard.Score score) {
            score(score);
        }
         ...
         * @param score The score for the text builder
         */
        public Score(Text text, nl.jk_5.pumpkin.api.scoreboard.Score score) {
            super(text);
            score(score);
        }
         ...
         */
        public final nl.jk_5.pumpkin.api.scoreboard.Score getScore() {
            return this.score;
        }
         ...
         * @see Text.Score#getScore()
         */
        public Score score(nl.jk_5.pumpkin.api.scoreboard.Score score) {
